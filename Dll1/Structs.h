...
DWORD_PTR OFFSET_FOV = 0x04D4E728;
DWORD Entity_Offset = 0x08;

DWORD_PTR WEAP_OFFSET = 0x036CBDC8;
DWORD_PTR NAME_OFFSET = 0x4d93b48;
DWORD_PTR CHAT_OFFSET = 0x03E423C8;
DWORD_PTR OFFSET_GAMESTATUS = 0x4E82918;
DWORD_PTR OFFSET_TRIGGERMANAGER = 0x04EBDF00;


DWORD_PTR OFFSET_GAMERENDERER = 0x4DA32C0;
DWORD_PTR OFFSET_GAMEMANAGER = 0x4EBD3C8;
DWORD_PTR OFFSET_NAMEMANAGER = 0x4E77AF0;
DWORD_PTR OFFSET_NETWORKMANAGER = 0x4D96538;
DWORD_PTR OFFSET_INTERFACEMANAGER = 0x4EBBCC0;
DWORD_PTR OFFSET_LOCALPLAYER = 0x4EBD3D0;
